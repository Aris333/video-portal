...
import FullMediaView from './views/FilePages/FullMediaView'
...
const routesAdmin = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () =>
                    import(/* webpackChunkName: "chunks/app-others" */ './views/Admin/Package/AddPackage'),
                meta: {
                    requiresAuth: true,
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        path: '/admin/package',
                        component: () =>
                            import(/* webpackChunkName: "chunks/app-others" */ './views/Admin/Package/Package'),
                        meta: {
                            requiresAuth: true,
                            title: i18n.t('routes_title.package')
                        },
                    },
                    {
                        name: 'AddPackage',
                        path: '/admin/package/create',
                        component: () =>
                            import(/* webpackChunkName: "chunks/user-create" */ './views/Admin/Package/AddPackage'),
                        meta: {
                            requiresAuth: true,
                            title: i18n.t('routes_title.add_package')
                        },
                    },
                ]
            },
...
const routesShared = [
    ...
    },
    {
        ...
        path: '/sharedFolder/:token',
        component: () =>
            import(/* webpackChunkName: "chunks/shared-page" */ './views/Shared/SharedFolderPage'),
        meta: {
            requiresAuth: true
        },
    },
    {
        ...
        path: '/sharedPresentation/:token',
        component: () =>
            import(/* webpackChunkName: "chunks/shared-page" */ './views/Shared/SharedPresentationPage'),
        meta: {
            requiresAuth: true
        },
    },
    {
        ...
        path: '/sharedReview/:token',
        component: () =>
            import(/* webpackChunkName: "chunks/shared-page" */ './views/Shared/SharedReviewPage'),
        meta: {
            requiresAuth: true
        },
    },
...
const routesUser = [
    ...
    },
    {
        ...
        path: '/comparisonMedia/:id',
        component: () =>
            import(/* webpackChunkName: "chunks/files" */ './views/FilePages/ComparisonMediaView'),
        meta: {
            requiresAuth: false
        },
    },
    ...
    },
    {
        ...
        path: '/files/:id',
        component: () =>
            import(/* webpackChunkName: "chunks/files" */ './views/FilePages/FullMediaView'),
        meta: {
            requiresAuth: false
        },
    },
    ...
    },
    {
        ...
        path: '/upgrade/komyt/plan',
        component: () =>
            import(/* webpackChunkName: "chunks/upgrade-plan" */ './views/Upgrade/UpgradeKomytPlan'),
        meta: {
            requiresAuth: true,
            title: i18n.t('routes_title.upgrade_plan')
        },
...
const routesIndex = [
    ...
    },
    {
        ...
        path: '/draw-files',
        component: () =>
            import(/* webpackChunkName: "chunks/shared-files" */ './views/FilePages/draw'),
        meta: {
            requiresAuth: true
        },
    },

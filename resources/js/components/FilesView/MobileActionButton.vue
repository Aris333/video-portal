<template>
    <button class="mobile-action-button">
        <div class="flex">
            ...
            <archive-icon v-if="icon === 'add-package'" size="15" class="icon"></archive-icon>
...
<script>
    import { FolderPlusIcon, ListIcon, GridIcon, TrashIcon, ArchiveIcon, UserPlusIcon, PlusIcon, CreditCardIcon } from 'vue-feather-icons'

                        ...
                        <div class="card card-white post" style="border-radius: 11px;">
                          ...
                          <div class="container">
                            ...
                            <div class="first">
                              ...
                              <button class="dropbtn float-right" style=" width:36px; border-radius:23px;"  @click="isActive =!isActive;showbtns=!showbtns; clearPaintable"><i class="fas fa-palette" style="color: #00BC7E !important;"  ></i></button>
...
export default {
  ...
  computed: {
    ...mapGetters(['myFileInfo','annotation','isProcessingFile','updateFps', 'data','user','allComments']),

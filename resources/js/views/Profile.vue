<template>
    <section id="viewport">
        ...
        <ContentSidebar>
            ...
            <ContentGroup title="Subscription" class="navigator"  v-if="user.data.attributes.role === 'user'">
<!--            <ContentGroup title="Subscription" class="navigator" v-if="canShowSubscriptionSettings">-->
                <div class="menu-list-wrapper vertical">
                    ...
                    <router-link replace :to="{name: 'UpgradeKomytPlan'}" class="menu-list-item link">
                        <div class="icon">
                          <cloud-icon size="17"></cloud-icon>
                        </div>
                        <div class="label">

                            ...
                            <div class="post-heading" style="margin-top: 10px">
                              <div class="float-left image">
                                <img
                                  ...
                                  style="border-radius: 20px; height: 40px!important; "
                              ...
                              <div class="float-left meta">
                                <div class="title h5">
                                  <input
                                    type="text"
                                    class=""
                                    style="width: 100%; margin-top:10px; color: #00BC7E !important; border:none;background:transparent;margin-left: 10px;margin-top: 3px;"
                                    placeholder="Comment"
                            ...
                            <div class="container">
                              <div class="first">
                                <transition-group name="slide-fade">
                                  <button
                                    v-if="
                                      showbtns && myFileInfo.type === 'video'
                                    "
                                    class="dropbtn"
                                    key="1"
                                    id="time_btn"
                                    style="margin-bottom: 2px;  color:black;borders-radius:11px; width: 98px"
                                  >
                                    <i
                                      class="fas fa-clock"
                                ...
                                <button
                                  ...
                                  id=""
                                  style="color:black;border-radius:23px; width: 78px;color: #00BC7E !important;"
                                  :disabled="comment == ''"
                                  @click="submitComment"
                                >
                                  Send
                    ...
                    >
                      <div class="progress" style="height:25px;">
                        ...
                        <v-popover
                          ...
                          :style="
                            'left:' +
                              (parseFloat(data.text_edited_at) / duration) *
                                100 +
                              '%;'
                          "
                          trigger="hover"
...
export default {
  ...
  updated() {
    ...
    $("#videoElement").css("height", $(window).height() - 300 + "px");
  ...
  methods: {
    ...
    drawImage(data) {
      ...
      if (data.annotation != "") {
        ...
        console.warn("annotation", process.env.MIX_API_BASE_URL);

        console.warn("annotation", process.env.API_URL_ROOT);
        // this.testImg =
          // process.env.API_URL_ROOT + "annotationImg/" + data.annotation;
        this.testImg=process.env.MIX_IMAGE_BASE_URL+'annotationImg/'+data.annotation;
        //   var img = new Image();

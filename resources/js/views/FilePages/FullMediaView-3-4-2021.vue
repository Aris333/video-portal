    ...
    <div class="col-md-12">
      ...
      <div class="media-full-preview"  v-show="isLoading ===false" >
        ...
        <div class="row" id="testing" >
                ...
                <div class="l-page" v-if="myFileInfo && myFileInfo.type === 'video' && currentFile.file_url" >
                  <div class="p-video-player" id="video-player">
                    ...
                    >
                      ...
                      <FrameVideo
                          v-if="myFileInfo.type === 'video'"
                          id="videoElement"
                          class="p-video-player__media"
                          :src=" myFileInfo.type === 'video'? myFileInfo.file_url :currentFile.thumbnail"
                    ...
                    <div class="p-video-player__seekbar-wrap-progress" id="video-player-media" v-if="myFileInfo && myFileInfo.type === 'video'">
                    ...
                    <div class="p-video-player__control-panel p-2" v-if="myFileInfo && myFileInfo.type === 'video'">
                      <div class="row">
                        <div class="col-sm-12">
          ...
          <div class="col-sm-3 pl-2 dynamic-theme-color"  style="right: 8px !important;" v-show="isLoading ===false">
            <div class="mt-3">
...
<!--													<time-ago :refresh="60" :datetime="childData.created_at" locale="en" tooltip style="color:white;    background-color: #fff; margin-left:10px;"></time-ago>-->
                      ...
                      <div class="pt-2" >
                        <div class="d-inline"      @click="showChildReplyByIndex = index && childData.id; reply=''; ">
                          <span class="pt-5 text-muted">Reply</span>
                        </div>
                        <div class="text-white d-inline ml-2" >
...
export default {
  name: 'FullMediaView',
  components: {
    FileReviewNavigationPanel, FilePreviewNavigationPanel,
  ...
  computed: {
    ...mapGetters(['myFileInfo','annotation','isProcessingFile','config','updateFps', 'data','user','allComments','isGetComment']),
  ...
  watch: {
    ...
    isActive(){
      if(this.isActive == false)
      {
        ...
        this.$refs.paintable.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height);
...
//console.log('paint',this.$refs.paintable )
    ...
    // setting for video
    if(this.myFileInfo && this.myFileInfo.type === 'video') {
      // $('.paintable').css( 'width','800px')
      ...
      if(this.$el.querySelector('#videoElement'))
        this.media = this.$el.querySelector('#videoElement');
  ...
  methods: {
    ...
    drawImage(data)
    {
      ...
      if(this.myFileInfo.type ==='video')
      {
        ...
        $('#image_currentFile').css('display','block')
      }
      // this.isActive =true
...
<!--const Login = () => import('./components/other/Login.vue')-->

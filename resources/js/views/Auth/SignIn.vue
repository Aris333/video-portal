<template>
    <AuthContentWrapper ref="auth">
        ...
        <AuthContent name="log-in" :visible="true">
            ...
            <ValidationObserver @submit.prevent="logIn"
                                ref="log_in" v-slot="{ invalid }"
                                tag="form"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['config','redirectUrl','isLoggedIn']),
        },
        data() {
            return {
                isLoading: false,
            ...
            async singIn() {
                ...
                axios
                    ...
                    .then((response) => {
                        ...
                        this.$store.commit('RETRIEVE_USER', response.data)
                      ...
                      window.location.href = 'sharedReview/'+this.shareRedirectUrl+'?q='+this.$route.query.q
                        // this.$router.push({
          ...
          if(this.$route.query.user_email)
          {
            ...
            axios
                ...
                .catch(error => {
                  ...
                  window.location.href='/sign-up?user_email='+this.loginEmail
                  this.$route.path()
                   }

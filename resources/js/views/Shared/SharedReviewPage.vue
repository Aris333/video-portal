...
<!--													<time-ago :refresh="60" :datetime="childData.created_at" locale="en" tooltip style="color:white;    background-color: #fff; margin-left:10px;"></time-ago>-->
                        ...
                        <div class="pt-2">
                          ...
                          <div class=" d-inline ml-2">
                            <span class="text-muted white">{{childData.comment}}</span>
                          </div>
                        </div>
                        <div class="pt-2" >
...
export default {
  ...
  async beforeCreate() {
    ...
    if(auth === "false" ||auth === null || auth === undefined)
    {
      ...
      var dec = atob(this.$route.query.q);
      // this.$route.query.q
      let q = this.$route.query ? dec : this.sharedFileID
...
//  this.media.height = "500";
    ...
    //
    //   var height = parseInt($lPage.height()) * 0.8 ;
    //
    //   $video.css('height', height);
    //
    //   var videoWidth = $video.width();
    // //       windowWidth = $lPage.width(),

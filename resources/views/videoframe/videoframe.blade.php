...
<!DOCTYPE html>
<html class="no-js not-webkit" manifest="cache.manifest">
<head>
<title>VideoFrame: HTML5 Video SMPTE Time Code capturing and Frame Seeking API</title>
<script src="{{asset('/videoframe/VideoFrame.min.js')}}" type=""></script>
...
<body>
	...
	<div class="row">
		<div class="col-md-12">
			<video id="video" controls="controls" muted crossorigin="anonymous">
		<source src="/testvideo.mkv">
	</video>

	 <button onClick="generateThumbnail()">getThumnail </button>
	<div id="time-ruler">
...
function generateThumbnail() {
  ...
  //var canvas1 = document.getElementById("paint-canvas");
  //var ctxx = canvas1.getContext("2d");
  //ctxx.drawImage(img, 10, 10);

  //append img in container div
  //document.getElementById('thumbnailContainer').append(img);
}

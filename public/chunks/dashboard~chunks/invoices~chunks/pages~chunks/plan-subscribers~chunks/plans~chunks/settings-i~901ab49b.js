(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunks/dashboard~chunks/invoices~chunks/pages~chunks/plan-subscribers~chunks/plans~chunks/settings-i~901ab49b"],{
              ...
              [
                _vm._l(_vm.data.data, function(row) {
                  return _vm._t(
                    "default",
                    [
                      _c("DatatableCell", { key: row.id, attrs: { data: row } })
                    ],
                    { row: row }
                  )
                })

...
class BrowseController extends Controller
{
    ...
    public function getImagesDownload($id)
    {
        // return $id;
        return FileManagerFile::with(['parent', 'shared:token,id,item_id,permission,protected,expire_in'])
            ->where('folder_id', $id)
            ->get();
        // return $this->download_file($files);
    }
